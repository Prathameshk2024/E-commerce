...
export const getfeaturedProducts = async(req,res)=>{
    try {
        ...
        // if it is not in redis then get it from mongo db
        // lean is gonna return plain js object instead of mongoose document
        // which is more efficient for read only operation
